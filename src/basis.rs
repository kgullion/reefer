...
use crate::{
    ...
    utils::{At, Count, CountOf, Get, SwapPar, SwapParity},
};
use core::marker::PhantomData;
use core::ops::{Add, BitAnd, BitXor, Neg, Not};
use typenum::{
    tarr, ATerm, Add1, And, Bit, Eq, Integer, IsEqual, Len, Sub1, Sum, TArr, TypeArray, UInt,
...
// -------------------------------------
/// Basis type alias to construct a new basis
...
type IsDegenerate<B> = <<B as BasisCart<B>>::Mul as BasisCart<ZeroVector>>::Equal;
/// simple alias for Not, to make the code a bit more readable
type Flip<B> = <B as Not>::Output;
